...
any data to a server (see the [privacy policy](https://homey-ap.github.io/cookie-defense/)).
Even so, it requests broad permissions (`cookies`, `<all_urls>`) to do its
job, so we take reports about it seriously.

## Reporting a vulnerability

Please use GitHub's [private vulnerability reporting](https://github.com/homey-ap/cookie-defense/security/advisories/new)
...
regular [GitHub issue](https://github.com/homey-ap/cookie-defense/issues) is fine.
